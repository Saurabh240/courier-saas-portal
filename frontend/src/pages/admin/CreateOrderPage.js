...
export default function CreateOrderPage() {
  const [formData, setFormData] = useState({
    ...
    packageType: "BOX",         // REQUIRED in backend response
              ...
              <div className="grid grid-cols-2 lg:grid-cols-6 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                    readOnly
                    className="w-full px-3 py-2 border border-gray-400 rounded-md text-sm bg-gray-50 focus:outline-none"
                  />
                </div>
                <div>
                  <label className="block text-xs font-medium text-black-500 mb-1">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 mb-6">
                ...
                <label className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 border-gray-400 rounded focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-900">Do not turn</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    className="w-4 h-4 text-blue-600 border-gray-400 rounded focus:ring-blue-500"
                  />
                  <span className="text-sm text-gray-900">No radiations</span>
                </label>
                <label className="flex items-center space-x-2">
                  <input
                    type="checkbox"
